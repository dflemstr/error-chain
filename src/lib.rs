...
//!   optional, boxed [`std::error::Error`]` + [`Send`] + [`Sync`] + `'static` object
...
//!   [`chain_err`] method. This method on all [`std::error::Error`] + [`Send`] + [`Sync`] + `'static`
...
//!   to match.
//! * Because the error type contains [`std::error::Error`] + [`Send`] + [`Sync`] + `'static` objects,
...
//! error type implements [`std::error::Error`] + [`Send`] + [`Sync`] + `'static`, as long as
